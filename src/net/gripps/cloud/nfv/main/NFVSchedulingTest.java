...
*/
        ...
        KHEFTAlgorithm peft = new KHEFTAlgorithm(env4, sfc4);
        peft.mainProcess();
        System.out.println("SLR[KHEFT]:" + NFVUtil.getRoundedValue(peft.getMakeSpan() / peft.getTotalCPProcTimeAtMaxSpeed()) + " / # of vCPUs: " + peft.getAssignedVCPUMap().size() + "/ # of Hosts:" + peft.getHostSet().size()
