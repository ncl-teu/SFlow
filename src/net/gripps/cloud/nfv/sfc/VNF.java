...
import org.ncl.workflow.ccn.autoicnsfc.VDependence;
...
public class VNF  implements Serializable{
    ...
    protected LinkedList<VDependence> VDpredList;

    protected LinkedList<VDependence> VDsucList;

    protected double blevelWST;
    ...
    public void setVDpredList(LinkedList<VDependence> VDpredList) {
        this.VDpredList = VDpredList;
    }

    public LinkedList<VDependence> getVDsucList() {
        return VDsucList;
    }

    public void setVDsucList(LinkedList<VDependence> VDsucList) {
        this.VDsucList = VDsucList;
    }
    ...
    public VNF(int in_type, long weight, long requiredMips, long requiredRecvBW, long  requiredSendBW, String  vCPUID, int percent) {
        ...
        this.VDpredList = new LinkedList<VDependence>();
        this.VDsucList = new LinkedList<VDependence>();
        ...
        this.dominantWSTSucID = new Long(-1);
        this.usage = percent ;
        this.clusterID = -1L;
    ...
    public double getBlevelWST() {
        return blevelWST;
    }

    public void setBlevelWST(double blevelWST) {
        this.blevelWST = blevelWST;
    }

    public Long getDominantWSTSucID() {
        return dominantWSTSucID;
    }

    public void setDominantWSTSucID(Long dominantWSTSucID) {
        this.dominantWSTSucID = dominantWSTSucID;
    }
    ...
    public void setInterestSent(boolean interestSent) {
        isInterestSent = interestSent;
    }
