 ...
 */
public class JPDC_GroupingTestPEFT_multi {
        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
               ...
               // BBTask mwsl_apl = HEFT_Algorithm..multiCoreProcess();
                ...
                System.out.print("PEFT:" + mwsl_apl.getMakeSpan() + ":" + mSet.getList().size() +":" + mwsl_apl.getWorstLevel() + ":" + SLR_mwsl + ":" + e_value_mwsl);
              ...
              //  CMWSL_Algorithm hetero2 = new CMWSL_Algorithm(apl_grouping,filename, env_group);
                ...
                System.out.print(":PEFT2:" + ret_group.getMakeSpan() + ":" + retSet.getList().size() + ":" + ret_group.getWorstLevel() + ":" + SLR_distance + ":" + e_value_distance);
                ...
                System.out.print(":PEFT3:" + ret_group2.getMakeSpan() + ":" + retSet2.getList().size() + ":" + ret_group2.getWorstLevel() + ":" + SLR_distance2 + ":" + e_value_distance2);
