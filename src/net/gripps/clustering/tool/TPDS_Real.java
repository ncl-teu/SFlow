        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
               ...
               Iterator<AbstractTask> taskIte =  apl.getTaskList().values().iterator();
                ...
                double ave_dataSize = Calc.getRoundedValue(totalDataSize/dataNum);
                double ave_taskSize = Calc.getRoundedValue(totalTaskSize/taskNum);
                double CCR = Calc.getRoundedValue(ave_dataSize/ave_taskSize);
                System.out.println("Task#:"+taskNum+":CCR:"+CCR);
                System.out.println("SL by one :"+totalTaskSize/12);
...
// BBTask LBaplCopy = (BBTask)apl.deepCopy();
                ...
                ClusterMappingManager cm_manager = new ClusterMappingManager(filename, apl, path);
