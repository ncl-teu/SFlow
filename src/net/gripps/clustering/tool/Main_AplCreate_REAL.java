 ...
 * Date: 2007/07/17
 */
public class Main_AplCreate_REAL {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Efficiency(LB): " + Calc.getRoundedValue((long) 1 / (ret_mkRateLBC * sum_clusternum_lbc)));
            System.out.println();
            ...
            System.out.println("Efficiency(CASS): " + Calc.getRoundedValue((long) 1 / (ret_mkRateCASS * sum_clusternum_cass)));
            System.out.println();
            ...
            System.out.println("Efficiency(DSC): " + Calc.getRoundedValue((long) 1 / (ret_mkRateDSC * sum_clusternum_dsc)));
            System.out.println();
            ...
            */
            System.out.println("LB:" + ptime_lb1);
            double epsilon = Math.ceil((sum_optDelta / LOOP_NUM)/ taskSize_Min);
