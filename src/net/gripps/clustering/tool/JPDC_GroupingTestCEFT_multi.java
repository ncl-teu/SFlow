 ...
 */
public class JPDC_GroupingTestCEFT_multi {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
                ...
                CEFTCandidateNodeSelectionManager  grouping2 = new CEFTCandidateNodeSelectionManager(apl_distance, filename, env3);
                Hashtable<Long, CPU> cpuMap2 = grouping2.deriveCaindidateCPUMapByCEFT2();
               ...
               // BBTask mwsl_apl = CEFT_Algorithm..multiCoreProcess();
                CEFT_Algorithm heft = new CEFT_Algorithm(apl, filename, cm_manager.getEnv());
                ...
                System.out.print("CEFT:" + mwsl_apl.getMakeSpan() + ":" + mSet.getList().size() +":" + mwsl_apl.getWorstLevel() + ":" + SLR_mwsl + ":" + e_value_mwsl);
              ...
              //  CMWSL_Algorithm hetero2 = new CMWSL_Algorithm(apl_grouping,filename, env_group);
                ...
                System.out.print(":CEFT2:" + ret_group.getMakeSpan() + ":" + retSet.getList().size() + ":" + ret_group.getWorstLevel() + ":" + SLR_distance + ":" + e_value_distance);


                Hashtable<Long, CPU> cpu_table_peft2 = new Hashtable<Long, CPU>();

                CEFT_Algorithm hetero3 = new CEFT_Algorithm(apl_distance, filename, env_group2);
                //メイン処理を行う．
                ...
                System.out.print(":CEFT3:" + ret_group2.getMakeSpan() + ":" + retSet2.getList().size() + ":" + ret_group2.getWorstLevel() + ":" + SLR_distance2 + ":" + e_value_distance2);
