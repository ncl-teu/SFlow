 ...
 */
public class JPDC_DAX_CEFT_multi {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
                ...
                CEFTCandidateNodeSelectionManager  grouping2 = new CEFTCandidateNodeSelectionManager(apl_priority, filename, env3);
               ...
               //System.out.println("mapping2:"+cpuMap2.size());
                ...
                /**CEFTアルゴリズムSTART**/
               // BBTask mwsl_apl = CEFT_Algorithm..multiCoreProcess();
                CEFT_Algorithm CEFT = new CEFT_Algorithm(apl, filename, allnodes_env);
                BBTask mwsl_apl = CEFT.process();
              ...
              //  CMWSL_Algorithm hetero2 = new CMWSL_Algorithm(apl_grouping,filename, env_group);
                CEFT_Algorithm hetero2 = new CEFT_Algorithm(apl_grouping, filename, env_group);
                //メイン処理を行う．
                ...
                CEFT_Algorithm hetero3 = new CEFT_Algorithm(apl_priority, filename, env_group2);
                //メイン処理を行う．
                ...
                CEFT_Algorithm hetero_homo = new CEFT_Algorithm(apl_homo,filename, env_group_homo);
                ...
                CEFT_Algorithm hetero_com = new CEFT_Algorithm(apl_com, filename, env_group_com);
                ...
                while(jobIte.hasMoreElements()){
                    ...
                    CEFT_Algorithm  allnodes = new CEFT_Algorithm(job_allnodes, filename, envall_single);
                    ...
                    CEFT_Algorithm lbcns_default = new CEFT_Algorithm(job_default, filename, env_group_single);
                    ...
                    CEFT_Algorithm lbcns_priority = new CEFT_Algorithm(job_priority, filename, env_group_priority_single);
                    ...
                    CEFT_Algorithm lbcns_similar = new CEFT_Algorithm(job_similar, filename, env_group_homo_single);
                    ...
                    CEFT_Algorithm  lbcns_com = new CEFT_Algorithm(job_com, filename, env_group_com_single);
