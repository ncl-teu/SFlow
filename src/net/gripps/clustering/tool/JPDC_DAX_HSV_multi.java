 ...
 */
public class JPDC_DAX_HSV_multi {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
                ...
                HSVCandidateNodeSelectionManager  grouping2 = new HSVCandidateNodeSelectionManager(apl_priority, filename, env3);
               ...
               //System.out.println("mapping2:"+cpuMap2.size());
                ...
                /**HSVアルゴリズムSTART**/
               // BBTask mwsl_apl = HSV_Algorithm..multiCoreProcess();
                HSV_Algorithm HSV = new HSV_Algorithm(apl, filename, allnodes_env);
                BBTask mwsl_apl = HSV.process();
              ...
              //  CMWSL_Algorithm hetero2 = new CMWSL_Algorithm(apl_grouping,filename, env_group);
                ...
                HSV_Algorithm hetero3 = new HSV_Algorithm(apl_priority, filename, env_group2);
                //メイン処理を行う．
                ...
                HSV_Algorithm hetero_homo = new HSV_Algorithm(apl_homo,filename, env_group_homo);
                ...
                HSV_Algorithm hetero_com = new HSV_Algorithm(apl_com, filename, env_group_com);
                ...
                while(jobIte.hasMoreElements()){
                    ...
                    HSV_Algorithm  allnodes = new HSV_Algorithm(job_allnodes, filename, envall_single);
                    ...
                    HSV_Algorithm lbcns_default = new HSV_Algorithm(job_default, filename, env_group_single);
                    ...
                    HSV_Algorithm lbcns_priority = new HSV_Algorithm(job_priority, filename, env_group_priority_single);
                    ...
                    HSV_Algorithm lbcns_similar = new HSV_Algorithm(job_similar, filename, env_group_homo_single);
                    ...
                    HSV_Algorithm  lbcns_com = new HSV_Algorithm(job_com, filename, env_group_com_single);
