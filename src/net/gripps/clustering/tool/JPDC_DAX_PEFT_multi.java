 ...
 */
public class JPDC_DAX_PEFT_multi {
    public static void main(String[] args) {
        ...
        try {
            ...
            for (int i = 0; i < LOOP_NUM; i++) {
                ...
                PEFTCandidateNodeSelectionManager  grouping2 = new PEFTCandidateNodeSelectionManager(apl_priority, filename, env3);
               ...
               //System.out.println("mapping2:"+cpuMap2.size());
                ...
                /**PEFTアルゴリズムSTART**/
               // BBTask mwsl_apl = PEFT_Algorithm..multiCoreProcess();
                PEFT_Algorithm PEFT = new PEFT_Algorithm(apl, filename, allnodes_env);
                BBTask mwsl_apl = PEFT.process();
              ...
              //  CMWSL_Algorithm hetero2 = new CMWSL_Algorithm(apl_grouping,filename, env_group);
                ...
                PEFT_Algorithm hetero3 = new PEFT_Algorithm(apl_priority, filename, env_group2);
                //メイン処理を行う．
                ...
                while(jobIte.hasMoreElements()){
                    ...
                    PEFT_Algorithm  allnodes = new PEFT_Algorithm(job_allnodes, filename, envall_single);
                    ...
                    PEFT_Algorithm lbcns_default = new PEFT_Algorithm(job_default, filename, env_group_single);
                    ...
                    PEFT_Algorithm lbcns_priority = new PEFT_Algorithm(job_priority, filename, env_group_priority_single);
                    ...
                    PEFT_Algorithm lbcns_similar = new PEFT_Algorithm(job_similar, filename, env_group_homo_single);
                    ...
                    PEFT_Algorithm  lbcns_com = new PEFT_Algorithm(job_com, filename, env_group_com_single);
