...
public class WorkflowJsonLoader {
    ...
    public SFC loadNFDJob(String path){
        try {
            ...
            this.job = new WorkflowJob(this.root.get("job_id").longValue(), new HashMap<Long, Task>(), new HashMap<Long, NFDTask>());
            ...
            while(nodeIte.hasNext()){
                ...
                NFDTask task = new NFDTask(this.root.get("job_id").longValue(),taskid,
                        null,null,null,null,null,null );
                task.setDocker_image(docker_image);
                task.setDocker_tar(docker_tar);

                this.job.getNfdTaskMap().put(taskid, task);
            ...
            while(nodeIte2.hasNext()){
                ...
                NFDTask task = (NFDTask)this.job.getNfdTaskMap().get(vnf.getIDVector().get(1));
