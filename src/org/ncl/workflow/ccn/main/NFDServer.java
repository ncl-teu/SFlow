...
import com.intel.jndn.utils.processing.impl.SigningStage;
import com.intel.jndn.utils.server.RepositoryServer;
import com.intel.jndn.utils.server.impl.SegmentedServer;
...
public class NFDServer implements OnData, OnInterestCallback{
    ...
    protected KeyChain keyChain_;
    protected Name certificateName_;
    ...
    public static void main(String[] args){
        try{
            Face face = new Face("192.168.1.174");
...
*/
            Name prefix = new Name("/example/testApp/randomData");

            /*
            NFDServer server = new NFDServer();
            face.setInterestFilter(prefix, server);
...
*/
           ...
           //SimpleServer s = new SimpleServer(face, prefix);
           //s.register();
           // s.run();
           // s.register();
           ...
           // server.serve();
          // server.serve(data); // call face.processEvents() in an event loop

// add signatures; this pipeline stage will sign each Data packet prior to being encoded for transport
            //server.addPostProcessingStage(new SigningStage(keyChain, new Name("/testname/KEY/123")));
/*
            System.out.println("Register prefix  " + prefix.toUri());
            InterestReceiver echo = new InterestReceiver();

            long ret =  face.registerPrefix(prefix, echo, echo);
            System.out.println("**Returned val: "+ ret);
*/
            // The main event loop.
