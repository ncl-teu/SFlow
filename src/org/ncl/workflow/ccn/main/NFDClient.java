 ...
 */
public class NFDClient implements OnData, OnInterestCallback {
    ...
    public static void main(String[] args){
        ...
        Name name =  new Name("/example/testApp/randomData/"/*+ Math.floor(Math.random() * 100000)*/);
        try{
            Face face = new Face("192.168.10.7");
            //Data singleData = SimpleClient.getDefault().getSync(face, name);
            //System.out.println("data:"+singleData.getName());
          ...
          */
            ...
            NFDClient client = new NFDClient();

            face.expressInterest(interest, client);
            while (true) {
                face.processEvents();
                try{
                    Thread.sleep(10);
            ...
            /**
             DataReceiver counter = new DataReceiver();
             face.expressInterest(name, counter, counter);


             // The main event loop.
             while (counter.callbackCount_ < 5) {
             face.processEvents();
